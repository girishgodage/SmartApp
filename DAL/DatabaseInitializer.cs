    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        public async Task SeedAsync()
        {
            ...
            if (!await _context.Users.AnyAsync())
            {
                ...
                await CreateUserAsync("admin", "123Pa$$word.", "Inbuilt Administrator", "admin@gmail.com", "+1 (123) 000-0000", new string[] { adminRoleName });
                await CreateUserAsync("user", "123Pa$$word.", "Inbuilt Standard User", "user@gmail.com", "+1 (123) 000-0001", new string[] { userRoleName });
            ...
            if (!await _context.Customers.AnyAsync() && !await _context.ProductCategories.AnyAsync())
            {
                ...
                {
                    Name = "John Carter",
                    Email = "johncarter@anonymous.com",
