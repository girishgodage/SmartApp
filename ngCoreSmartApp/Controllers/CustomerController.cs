...
using DAL;
using ngCoreSmartApp.ViewModels;
using AutoMapper;
using Microsoft.Extensions.Logging;
using ngCoreSmartApp.Helpers;

namespace ngCoreSmartApp.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        public async Task<string> Email()
        {
            ...
            (bool success, string errorMsg) = await _emailSender.SendEmailAsync(recepientName, recepientEmail, "Test Email from $safeprojectname$", message);
