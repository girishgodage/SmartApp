...
using ngCoreSmartApp.Authorization;
using ngCoreSmartApp.Helpers;
using System;
using System.Collections.Generic;
using AppPermissions = DAL.Core.ApplicationPermissions;

namespace ngCoreSmartApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ApplicationDbContext>(options =>
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("ngCoreSmartApp")));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.DocumentTitle = "Swagger UI - ngCoreSmartApp";
            ...
            app.UseSpa(spa =>
            {
                ...
                if (env.IsDevelopment())
                {
                    ...
                    spa.Options.StartupTimeout = TimeSpan.FromSeconds(280); // Increase the timeout if angular app is taking longer to startup
